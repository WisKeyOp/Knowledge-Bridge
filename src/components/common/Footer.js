    ...
    return (
        <div className='bg-richblack-800 w-screen p-4 flex justify-center sm:flex-col items-center h-[25vh] gap-8 sm:gap-4 rounded-t-full mt-24 sm:rounded-t-3xl sm:h-max'>
            ...
            <div className='flex gap-8 text-4xl ml-60 sm:ml-0 sm:h-max'>
                <a href="mailto:keshavdutt6125@gmail.com" className='flex justify-center items-center p-2 rounded-xl  bg-richblack-700 bg-opacity-80 hover:bg-red-400 hover:bg-opacity-80 transition-all duration-1000'><GoMail /></a>
                <Link to="https://github.com/keshav6125" className='flex justify-center items-center p-2 rounded-xl  bg-richblack-700 bg-opacity-80 hover:bg-purple-500 hover:bg-opacity-80 transition-all duration-1000'><FaGithub /></Link>
                <Link to="https://www.linkedin.com/in/keshav-dutt-gautam-71469b273/" className='flex justify-center items-center p-2 rounded-xl bg-richblack-700 bg-opacity-80 hover:bg-blue-600 hover:bg-opacity-80 transition-all duration-1000'><FaLinkedinIn /></Link>
            </div>
        </div>
    )
}
